...
namespace Carbon.Media.Tests
{
    public class StrideTests
    {
        ...
        {
            var strides = new VideoFormatInfo(PixelFormat.Rgba32, 800, 600).GetStrides();
        ...
        {
            var strides = new VideoFormatInfo(PixelFormat.Rgb24, 800, 600).GetStrides();
        ...
        {
            var strides = new VideoFormatInfo(PixelFormat.Yuv410p, 800, 600).GetStrides();
