...
namespace Carbon.Media
{
    public sealed class Mime : IEquatable<Mime>
    {
        ...
        // Audio (2000-2999)
        public static readonly Mime Aac      = new Mime("audio/aac",              new[] { "aac", "m4a" }, new[] { MagicNumber.Aac_1, MagicNumber.Aac_2 });
        ...
        public static readonly Mime Mp3      = new Mime("audio/mpeg",             new[] { "mp3" }, new[] { MagicNumber.Mp3_1, MagicNumber.Mp3_2 });
        public static readonly Mime Mpc      = new Mime("audio/musepack",         "mpc");
        public static readonly Mime M4a      = new Mime("audio/mp4",              new[] { "m4a" }, new[] { MagicNumber.M4a });
        ...
        public static readonly Mime Dng      = new Mime("image/dng",              new[] { "dng" });
        ...
        public static readonly Mime Jpeg     = new Mime("image/jpeg",             new[] { "jpeg", "jpg", "jpe", "jif", "jfif", "jfi" }, new[] { MagicNumber.Jpeg_1, MagicNumber.Jpeg_2, MagicNumber.Jpeg_3 });
        public static readonly Mime Jxr      = new Mime("image/jxr",              new[] { "jxr", "hdp", "wdp" });
        public static readonly Mime Orf      = new Mime("image/x-olympus-orf",    new[] { "orf" });
        ...
        public static readonly Mime Raf      = new Mime("image/image/x-fuji-raf", new[] { "raf" }, new[] { MagicNumber.Raf });
        public static readonly Mime Sgi      = new Mime("image/sgi",              new[] { "sgi" });
        public static readonly Mime Svg      = new Mime("image/svg+xml",          new[] { "svg" });
        public static readonly Mime Tga      = new Mime("image/targa",            new[] { "tga" });
        public static readonly Mime Tiff     = new Mime("image/tiff",             new[] { "tiff", "tif" }, new[] { MagicNumber.Tiff_1, MagicNumber.Tiff_2 });
        public static readonly Mime WebP     = new Mime("image/webp",             new[] { "webp" });
        ...
        public static readonly Mime M4v      = new Mime("video/mp4",        new[] { "m4v" }, new[] { MagicNumber.M4v });
        public static readonly Mime Mov      = new Mime("video/quicktime",  new[] { "mov" }, new[] { MagicNumber.Mov_1, MagicNumber.Mov_2 });
        public static readonly Mime Mp4      = new Mime("video/mp4",        new[] { "mp4", "m4v" }, new[] { MagicNumber.Mp4_1, MagicNumber.Mp4_2, MagicNumber.Mp4_3, MagicNumber.Mp4_4 });
        public static readonly Mime Mpeg     = new Mime("video/mpeg",       new[] { "mpeg" }, new[] { MagicNumber.Mpeg_1 });
