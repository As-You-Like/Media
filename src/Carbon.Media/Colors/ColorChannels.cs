namespace Carbon.Media
{
    public struct ColorChannel
    {
        ...
        public static ColorChannel Cb(byte bitCount)      => new ColorChannel(ColorComponent.Cb,      bitCount);
        public static ColorChannel Cr(byte bitCount)      => new ColorChannel(ColorComponent.Cr,      bitCount);
